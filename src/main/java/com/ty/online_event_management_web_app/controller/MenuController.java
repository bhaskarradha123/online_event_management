...
public class MenuController {
	...
	public ResponseEntity<ResponseStructure<List<Menu>>> saveMenu(@Valid @RequestBody List<Menu> menu,
	...
	@GetMapping("/menus")
	@ApiOperation(value = "display Menus", notes = "Api is used to display Menus with given Organizer email ")
	@ApiResponses({ @ApiResponse(code = 201, message = "Sucessfully found to display "),
			@ApiResponse(code = 404, message = " id  is not Found for the given Menu id") })
	public ResponseEntity<ResponseStructure<List<Menu>>> getMenuById(@RequestParam String email) {
		return service.getAllMenuByEmail(email);
	}
