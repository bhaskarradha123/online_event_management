...
public class ApplicationExceptionHandler extends ResponseEntityExceptionHandler {
	...
	public ResponseEntity<ResponseStructure<String>> idNotFoundByCostumeException(
			IdNotFoundByCostumeException exception) {
		ResponseStructure<String> structure = new ResponseStructure<String>();
	...
	public ResponseEntity<ResponseStructure<String>> idNotFoundByDecorationException(
			IdNotFoundByDecorationException exception) {
		ResponseStructure<String> structure = new ResponseStructure<String>();
	...
	@ExceptionHandler(NoSuchElementFoundByVenuexception.class)
	public ResponseEntity<ResponseStructure<String>> noSuchElementException(
			NoSuchElementFoundByVenuexception exception) {
		ResponseStructure<String> structure = new ResponseStructure<String>();

		structure.setMessage(exception.getMessage());
		structure.setStatus(HttpStatus.NOT_FOUND.value());
		structure.setData("No Such Element is Found In Venue Entity beacuse id is not Exist");
		return new ResponseEntity<ResponseStructure<String>>(structure, HttpStatus.NOT_FOUND);
	}
